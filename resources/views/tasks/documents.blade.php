...
<x-layouts.vigia :title="'Evidencias: ' . $task->title">
    <x-slot name="breadcrumb">
        <a href="{{ route('assets.index') }}" class="text-gray-600 hover:underline">Activo y Actividades</a>
        ...
        <div class="flex items-start justify-between gap-6">
            <div class="space-y-1">
                ...
                <div class="text-sm text-gray-500">
                    ...
                    · Carpeta: <span class="font-semibold text-gray-700">{{ $requirement->template?->name ?? $requirement->type }}</span>
                </div>
        ...
        <div class="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            @if(auth()->user()->isOperative())
                <div class="bg-white border rounded-xl overflow-hidden">
                    <div class="p-5 border-b">
                        <div class="font-semibold text-[#1A428A]">Subir evidencia</div>
                        <div class="text-sm text-gray-500">
            ...
            <div class="bg-white border rounded-xl overflow-hidden">
                <div class="p-5 border-b flex items-center justify-between">
                    <div>
                        <div class="font-semibold text-[#1A428A]">Documentos</div>
                        <div class="text-sm text-gray-500">
