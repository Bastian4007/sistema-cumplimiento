...
<head>
    ...
    <title>Formarás parte del flujo de aprobación</title>
    <style>
        ...
        .header { background: #6b7280; color: #fff; padding: 28px 32px; }
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Formarás parte de un flujo de aprobación</p>
        </div>
        <div class="body">
            <p>Hola <strong>{{ $notifiable->name }}</strong>,</p>
            <p>Se inició el flujo de aprobación de un documento en el que participas. Tu voto se solicitará
               más adelante, cuando el flujo llegue a tu paso — por ahora no necesitas hacer nada, solo
               te avisamos para que lo tengas en mente.</p>
            ...
            <p>Te avisaremos por correo, con instrucciones para revisar y decidir, en cuanto sea tu turno.</p>

            <a href="{{ route('processes.flow', $regulation) }}" class="btn">Ver flujo de aprobación</a>
        </div>
        <div class="footer">
